...
public class AboutAbalone extends javax.swing.JDialog {

    public AboutAbalone(java.awt.Frame parent) {
        super(parent);
        initComponents();
   ...
   private void initComponents() {
      ...
      org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(com.github.abalone.Abalone.class).getContext().getResourceMap(AboutAbalone.class);
      setTitle(resourceMap.getString("title")); // NOI18N
      setModal(true);
      setName("aboutBox"); // NOI18N
      setResizable(false);

      javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(com.github.abalone.Abalone.class).getContext().getActionMap(AboutAbalone.class, this);
